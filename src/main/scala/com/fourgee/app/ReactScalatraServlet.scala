...
class ReactScalatraServlet(system:ActorSystem) extends ReactscalatraStack with JacksonJsonSupport with FutureSupport {
  ...
  ConnectionPool.singleton("jdbc:postgresql://localhost:5432/worldcup", "wayblignaut", "")
